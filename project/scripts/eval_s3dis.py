...
from utils.util import AverageMeter, s3dis_metrics, sub_s3dis_metrics, s3dis_metrics_vis_CM, save_predicted_results_PLY
...
def main(config):
    ...
    if config.load_path:
        ...
        validate('resume', val_loader, model, criterion, config, num_votes=20)# default num_votes 20

    validate('Last', val_loader, model, criterion, config, num_votes=20) # default num_votes 20
