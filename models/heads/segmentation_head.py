...
class SceneSegHeadResNet(nn.Module):
    ...
    def forward(self, end_points):
        ...
        """yc
        upsampling, concat and 1x1conv (i.e. more points but less channels), contrary to encoding strategy
        ...
        - up0;res5 88x{3,1,3204} res4 304_{3,1,1152}; up(res5, res4)->304x2304 then concat res4 features-->304x3456->304x576 w. 1x1conv
        - up1;res4 304{3,1,1152} res3 1152_{3,1,576}; up(res4, res4)->1152x576 then concat res3 features-->1152x1152->1152x288 w. 1x1conv
        - up2;...4096x144
        - up3;...15000x72
